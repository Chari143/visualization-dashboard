...
Create a MongoDB database or Supabase from the JSON data given.
You can use any of these frameworks as per your best skillset:
Python FastAPI / Django (Backend) with React.js / Next.js / Angular,js / JavaScript/Bootstrap / (Frontend)
Next.js or MERN or MEAN Stack
Python or Node.js and React Native for mobile apps
...
Create API in Node,js / Python to get data from the MongoDB
